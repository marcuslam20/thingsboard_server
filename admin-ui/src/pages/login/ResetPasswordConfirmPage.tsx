      ...
      <Box sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', bgcolor: '#305680' }}>
        <Card sx={{ width: '100%', maxWidth: 450, mx: 2 }} elevation={8}>
          <CardContent sx={{ p: 4, textAlign: 'center' }}>
            ...
            <Typography color="text.secondary" sx={{ mb: 2 }}>The password reset link is invalid or has expired.</Typography>
  ...
  const onSubmit = async (data: ResetPasswordForm) => {
    ...
    try {
      ...
      if (msg.includes('expired') || msg.includes('invalid')) {
        navigate('/passwordResetLinkExpired', { replace: true });
      } else {
      ...
      <Card sx={{ width: '100%', maxWidth: 450, mx: 2 }} elevation={8}>
        <CardContent sx={{ p: 4 }}>
          <Box sx={{ textAlign: 'center', mb: 3 }}>
            ...
            <Typography variant="subtitle1" color="text.secondary" sx={{ mt: 1 }}>Reset Password</Typography>
          </Box>

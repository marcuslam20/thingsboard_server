...
public interface DeviceGroupService {
    ...
    Optional<DeviceGroup> findById(UUID groupId);

    List<DeviceGroup> findBySmartHomeId(SmartHomeId smartHomeId);

    void deleteGroup(UUID groupId);

    DeviceGroupMember addDevice(UUID groupId, DeviceId deviceId);

    void removeDevice(UUID groupId, DeviceId deviceId);

    List<DeviceGroupMember> findDevices(UUID groupId);
}

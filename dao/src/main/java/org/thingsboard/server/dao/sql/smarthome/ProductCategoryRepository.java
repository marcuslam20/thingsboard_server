...
public interface ProductCategoryRepository extends JpaRepository<ProductCategoryEntity, UUID> {
    ...
    Page<ProductCategoryEntity> findByTenantId(UUID tenantId, Pageable pageable);

    Optional<ProductCategoryEntity> findByTenantIdAndCode(UUID tenantId, String code);

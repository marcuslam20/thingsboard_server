...
@Data
@Entity
@Table(name = "alexa_oauth2_tokens")
public class AlexaOAuth2TokenEntity implements Serializable {
    ...
    public AlexaOAuth2TokenEntity() {
        super();
    }

    public AlexaOAuth2TokenEntity(UUID id, UUID tenantId, UUID userId, String alexaUserId,
